...
class AirStation:
    ...
    def _save_to_file(self, PM25, PM10):
        if datetime.datetime.day != self._current_day:
            self._current_day = datetime.datetime.day
            self._file_name = "/tmp/data_{}_{}_{}".format(datetime.datetime.year,datetime.datetime.month, datetime.datetime.day)
